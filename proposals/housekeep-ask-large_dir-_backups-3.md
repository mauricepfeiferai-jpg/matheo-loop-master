...
loop: housekeep-ask-large_dir-_backups
erstellt: durch hecate.system_housekeeper
telegram_approval: required
---

# Freigabe erforderlich: ask /root/_backups
...
## Freigabe
Antworte im Telegram mit `/approve housekeep-ask-large_dir-_backups` oder `/deny housekeep-ask-large_dir-_backups`.
