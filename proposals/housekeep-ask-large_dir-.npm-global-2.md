...
loop: housekeep-ask-large_dir-.npm-global
erstellt: durch hecate.system_housekeeper
telegram_approval: required
---

# Freigabe erforderlich: ask /root/.npm-global
...
## Freigabe
Antworte im Telegram mit `/approve housekeep-ask-large_dir-.npm-global` oder `/deny housekeep-ask-large_dir-.npm-global`.
