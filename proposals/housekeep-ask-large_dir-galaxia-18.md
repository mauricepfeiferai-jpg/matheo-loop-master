...
loop: housekeep-ask-large_dir-galaxia
erstellt: durch hecate.system_housekeeper
telegram_approval: required
---

# Freigabe erforderlich: ask /home/galaxia
...
## Freigabe
Antworte im Telegram mit `/approve housekeep-ask-large_dir-galaxia` oder `/deny housekeep-ask-large_dir-galaxia`.
