...
loop: housekeep-ask-large_dir-karpathy
erstellt: durch hecate.system_housekeeper
telegram_approval: required
---

# Freigabe erforderlich: ask /opt/karpathy
...
## Freigabe
Antworte im Telegram mit `/approve housekeep-ask-large_dir-karpathy` oder `/deny housekeep-ask-large_dir-karpathy`.
