...
loop: housekeep-ask-large_dir-maurice
erstellt: durch hecate.system_housekeeper
telegram_approval: required
---

# Freigabe erforderlich: ask /home/maurice
...
## Freigabe
Antworte im Telegram mit `/approve housekeep-ask-large_dir-maurice` oder `/deny housekeep-ask-large_dir-maurice`.
