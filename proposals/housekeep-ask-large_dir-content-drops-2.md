...
loop: housekeep-ask-large_dir-content-drops
erstellt: durch hecate.system_housekeeper
telegram_approval: required
---

# Freigabe erforderlich: ask /root/content-drops
...
## Freigabe
Antworte im Telegram mit `/approve housekeep-ask-large_dir-content-drops` oder `/deny housekeep-ask-large_dir-content-drops`.
