...
## Was wurde gefunden
Pfad `/opt/Kronos` vom Typ `opt`. Grösse: 25.4 MB. Alter: 43.4 Tage.
...
- Tests: ja
- Docker: nein
- Sprachen: json, py, md, yaml, sh
- Entrypoints: requirements.txt, README.md
- Services: keine
- Crons: keine
