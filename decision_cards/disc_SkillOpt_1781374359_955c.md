...
## Titel
/root/projects/SkillOpt (repo/project)

## Was wurde gefunden
Pfad `/root/projects/SkillOpt` vom Typ `repo/project`. Grösse: 23.8 MB. Alter: 11.0 Tage.
...
- Tests: nein
- Docker: nein
- Sprachen: py, md, yaml, json, sh
- Entrypoints: pyproject.toml, requirements.txt, README.md
- Services: keine
- Crons: keine
