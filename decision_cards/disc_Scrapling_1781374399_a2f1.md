...
## ID
`disc_Scrapling_1781374399_a2f1`
...
## Titel
/root/Scrapling (large_dir)

## Was wurde gefunden
Pfad `/root/Scrapling` vom Typ `large_dir`. Grösse: 375.1 MB. Alter: 41.1 Tage.
...
- Tests: ja
- Docker: ja
- Sprachen: py, js, md, json, sh
- Entrypoints: pyproject.toml, README.md
- Services: keine
- Crons: keine
